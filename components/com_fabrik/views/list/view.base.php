...
class FabrikViewListBase extends FabrikView
{
	...
	protected function csvJS(&$opts, $model)
	{
		...
		$csvOpts->popupwidth   = FabrikWorker::getMenuOrRequestVar('popup_width', '',false,'menu');
		$csvOpts->optswidth    = FabrikWorker::getMenuOrRequestVar('popup_opts_width', '',false,'menu');
